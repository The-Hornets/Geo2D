...
module Geo2d
  # Represents a right trapezoid (trapezoid with two right angles)
  class RightTrapezoid < Quadrilateral
    ...
    def ==(other)
      return false unless other.is_a?(RightTrapezoid)
    ...
    def validate_right_trapezoid
      ...
      raise ArgumentError, 'Points do not form a right trapezoid'
    end
  end
end
